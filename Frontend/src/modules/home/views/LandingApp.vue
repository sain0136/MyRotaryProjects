<template>
  <Main
    class="landing_app flex min-h-screen w-full grow flex-col bg-primary-white"
  >
    <LandingHeader />
    <GenericlModal
...
"
    ...
    />
    <router-view></router-view> <LandingFooter />
  </Main>
</template>
...
import GenericlModal from "@/components/common/modals/GenericlModal.vue";
