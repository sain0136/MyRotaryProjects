...
import BaseFileUpload from "../baseformComponents/BaseFileUpload.vue";
import BaseSelect from "../baseformComponents/BaseSelect.vue";
import BaseCheckBox from "../baseformComponents/BaseCheckBox.vue";
import BaseInputsText from "../baseformComponents/BaseInputsText.vue";
import BaseInputsTextEmail from "../baseformComponents/BaseInputsTextEmail.vue";
import BaseTextArea from "../baseformComponents/BaseTextArea.vue";
...
import { useRotaryStore } from "@/store/rotaryStore";
