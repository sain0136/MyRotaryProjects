        ...
        <div class="wrapper" :class="tailwind.DIVCOL">
          ...
          <form class="w-1/2" @submit.prevent="" novalidate>
            ...
            <h3 class="my-4 text-center text-lg font-bold text-primary-black">
              {{
                headerFormatter(
                  "Create an itemized list of the specific objectives of your project (one per line).*)"
                )
              }}
            </h3>
            <table
            ...
            >
              ...
              <tbody>
                <tr class="border bg-white">
                  ...
                  >
                    <button title="Add" @click="addToObjectives(objectiveItem)">
                ...
                >
                  ...
                  <td class="text-center">
                    ...
                    >
                      <font-awesome-icon
                        class="text-primary-black hover:text-primary-color"
                        icon="trash-alt"
                      ></font-awesome-icon>
                    </button>
                  </td>
          ...
          >fdfd/vDFg\kf;hgdfo
            ...
            <BaseInputsText
              v-model="
                projectToUpdateOrCreate.hostclub_information.sectionC
                  .cooperating_organizations[0].website_address
              "
              label="Website"
            />
            <h3 class="my-4 text-center text-lg font-bold text-primary-black">
              {{ headerFormatter("Cooperating Organization Contact Person") }}
            </h3>
            <div class="my-4">
              <BaseInputsText
                label=" Contact Name*"
                v-model="
                  projectToUpdateOrCreate.hostclub_information.sectionC
                    .cooperating_organizations[0].contact_person.name
                "
              />
              <BaseInputsText
                v-model="
                  projectToUpdateOrCreate.hostclub_information.sectionC
                    .cooperating_organizations[0].contact_person.address
                "
                label="Address"
              />
              <BaseInputsText
            ...
            />
            <BaseTextArea
              label="6. Describe the non-financial participation by Rotarians in the project.*"
              v-model="
                projectToUpdateOrCreate.extra_descriptions
            ...
            />
            <BaseTextArea
              label="7. If a co-operating organisation will be involved in the project, provide a letter stating its role in the project and how Rotarians will interface with the organisation."
              v-model="
                projectToUpdateOrCreate.extra_descriptions
            ...
            >
              ...
              {{
                "( " +
                store.loggedInUsersDistrict.district_details.ddfCapes.dmCap
              }}
          ...
          validateRequest: helpers.withMessage(
            ...
            () => {
              if (
                ...
                (this.districtMatchingGrantRequestLimit as number)
              ) {
                return false;
              } else {
                return true;
  ...
  methods: {
    ...
    addToFundsArray() {
      ...
      if (this.fundingSources.sourceName === "District Club Contribution") {
        ...
        let currentDDFAmount =
          ...
          this.fundingSources.amount;
        if (
          this.fundingSources.amount > this.districtMatchingGrantRequestLimit ||
          currentDDFAmount > this.districtMatchingGrantRequestLimit
        ) {
          window.scrollTo(0, 0);
          this.toast.display = true;
          this.toast.msg =
    ...
    addToBudget(
      ...
      const budgetItemObject = {
        ...
        itemCostLocalCurrency: itemCostLocal,
      };
      ...
      budgetItemObject.itemCostLocalCurrency = parseFloat(
        parseFloat(itemCostLocal.toString()).toFixed(2)
      );
      //   Fix later lol
      ...
      this.budgetItemCostLocalCurrency = 0;
    },
